...
var I18N={
  vi:{webTitle:'Mở HCLOU trong Telegram',webSub:'Web này chỉ sử dụng trong Telegram Mini App để xác thực tài khoản và bảo vệ key của bạn.',openTelegram:'🚀 Mở trong Telegram',tapChooseGame:'Nhấn chọn game',noGameSelected:'Chưa chọn game',noPackageSelected:'Chưa chọn gói',promo:'🔥 KHUYẾN MÃI HOT!',totalKey:'Tổng key',activeLabel:'Hoạt động',expiredLabel:'Hết hạn',buyNew:'Mua Key mới',buySub:'Chọn ứng dụng và gói ngày',chooseApp:'Chọn ứng dụng',choosePackage:'Chọn gói',buyNow:'Mua ngay',yourKeys:'Key của bạn',all:'Tất cả',lockedLabel:'Bị khoá',chooseGameTitle:'🎮 Chọn game',paymentTitle:'💳 Thanh toán',search:'Tìm kiếm GKey...',
    ...
    freeChecking2:'Đang kiểm tra...',freeClaimedToday:'Bạn đã nhận key free hôm nay!',freeReceivedAt:'Nhận lúc',freeBackTomorrow:'🔄 Quay lại vào 0h00 ngày mai để nhận key tiếp',freeKeyToday:'Key miễn phí hôm nay',freeSub:'Nhận ngay 1 key free mỗi ngày!<br>Admin đã thêm key sẵn, mỗi người nhận 1 link riêng',freeBtnGetLink:'🔗 Lấy Link Claim Key',freeResetDaily:'⏰ Reset lúc 0h00 hàng ngày',freePeopleSuffix:'người đã nhận hôm nay',freeNoneToday:'Chưa có key free hôm nay',freeAdminNotYet:'Admin chưa thêm key. Vui lòng quay lại sau!',freeNewMorning:'🔄 Key mới sẽ có vào buổi sáng hàng ngày',freeCannotLoad:'Không thể tải thông tin key free',freeCreatingLink:'⏳ Đang tạo link...',freeAlready:'Bạn đã nhận key free hôm nay rồi!',freeYourLink:'Link claim riêng của bạn:',freeOpenLink:'🔓 Mở Link Claim Key',freeCopyLink:'📋 Copy Link',freeCopiedLink:'Đã copy link!',freeLinkCreated:'✅ Đã tạo link — Mở link để nhận key',freeErrorGeneric:'Có lỗi xảy ra!',toastLoadErr:'Lỗi kết nối, thử lại sau!',loadingHistory:'Đang tải lịch sử...',histLoadFail:'⚠️ Không thể tải lịch sử đơn hàng',histGame:'Game',histPkg:'Gói',histCreated:'Ngày tạo',histPkgDays:'ngày',statusApproved:'Đã duyệt',statusRejected:'Đã từ chối',statusCancelled:'Đã huỷ',statusPending:'Chờ xử lý',accTitle:'Mua Acc',accSubtitle:'Chọn loại acc (Google, Facebook...)',accChooseLabel:'Chọn game & loại acc',accPickGameFirst:'Chọn game trước',accQtyLabel:'Số lượng acc',accQtyHint:'Mỗi đơn 1 acc · đổi mật khẩu ngay sau nhận',accBuyBtn:'Mua Acc',accNoTypeSelected:'Chưa chọn loại acc',accNote:'⚠️ Mỗi acc chỉ bán 1 lần. Đổi mật khẩu ngay sau khi nhận acc.',accMyTitle:'Acc của tôi',accNoneYet:'Chưa có acc nào',navAcc:'Mua Acc'
    Acc của tôi:'accMyTitle',
    Bị khoá:'biKhoa',
    Chưa chọn game:'noGameSelected',
    Chưa chọn gói:'noPackageSelected',
    Chưa chọn loại acc:'accNoTypeSelected',
    Chưa có acc nào:'accNoneYet',
    Chịu trách nhiệm nội dung:'footerRespContent',
    Chọn câu hỏi để xem hướng dẫn nhanh:'helpSub',
    Chọn game:'chonGame',
    Chọn game & loại acc:'accChooseLabel',
    Chọn game trước:'accPickGameFirst',
    Chọn gói:'choosePackage',
    Chọn loại acc (Google, Facebook...):'accSubtitle',
    Chọn ứng dụng:'chooseApp',
    Chọn ứng dụng và gói ngày:'buySub',
    Chờ xử lý:'statusPending',
    Chứng chỉ trang web:'footerCertSite',
    Chứng nhận:'footerCert',
    Cá nhân:'navProfile',
    Email liên hệ:'footerEmail',
    Hoạt động:'hoatDong',
    Huỷ:'huy',
    Hết hạn:'hetHan',
    Họ tên:'profileFullName',
    Hỗ trợ thanh toán:'footerPaymentSupport',
    Key của bạn:'yourKeys',
    Key đang có:'profileKeysOwned',
    Kết nối mạng xã hội:'footerSocial',
    Liên hệ hỗ trợ:'footerSupport',
    Liên kết nhanh:'profileLinks',
    Lịch sử:'navHistory',
    Mua Key mới:'buyNew',
    Mã số thuế:'footerTaxId',
    Mỗi đơn 1 acc · đổi mật khẩu ngay sau nhận:'accQtyHint',
    Ngày tham gia:'profileJoined',
    Nhấn chọn game:'tapChooseGame',
    Phương thức thanh toán:'footerPayment',
    Phản ánh chất lượng:'footerComplaint',
    SỐ DƯ HIỆN TẠI:'currentBalance',
    Số GPKD:'footerBizLic',
    Số dư:'balanceLabel',
    Số dư ví:'walletBalance',
    Số lượng acc:'accQtyLabel',
    Thông tin tài khoản:'profileAccount',
    Tất cả:'all',
    Tổng key:'totalKey',
    Tổng quan:'profileOverview',
    Tổng đơn:'profileTotalOrders',
    Xác nhận:'xacNhan',
    Đang cập nhật:'footerUpdating',
    Đang kiểm tra key...:'freeChecking',
    Đang tải...:'dangTai',
    Đã duyệt:'statusApproved',
    Địa chỉ:'footerAddress',
    Đồng Ý:'dongY',
    ⚠️ Mỗi acc chỉ bán 1 lần. Đổi mật khẩu ngay sau khi nhận acc.:'accNote',
    ⭐ Key miễn phí mỗi ngày:'freeDayTitle',
    🎮 Chọn game:'chooseGameTitle',
    💰 Nạp tiền:'topupNav',
    💳 Nạp tiền vào ví:'topupTitle',
    💳 Thanh toán:'paymentTitle',
    📜 Lịch sử ví:'balanceHistoryTitle',
    📜 Lịch sử đơn hàng:'historyTitle',
    🔄 Tải lại:'profileBtnReload',
},
  ...
  if(sub){
    if(selPkg && !selPkg.is_free){
      ...
      if(selQty>1){
        ...
        sub.textContent='Tổng: '+fmtMoney(total)+'đ × '+selQty+' key';
      } else {
...
function showPaymentMethodPicker(){
  ...
  if(paymentOptions.card){
    html+='<button onclick="pickPayment(\'card\')" style="'+btnBase+';border-color:rgba(168,85,247,.4);background:linear-gradient(135deg,rgba(168,85,247,.14),rgba(192,132,252,.06))"><span style="font-size:24px">💳</span><span><b>Thẻ cào</b><div style="font-size:11px;opacity:.8;font-weight:500;margin-top:2px">Viettel/Mobifone/Vinaphone (qua ví)</div></span></button>';
  }
  html+='</div>';

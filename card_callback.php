...
try {
    ...
    if ($status === 1 || $status === 2) {
        // Thành công. Cộng vào ví theo value thực × markup.
        // value (face_value thực) / multiplier = balance_credited
        $multiplier = defined('CARD_BALANCE_MULTIPLIER') ? (float)CARD_BALANCE_MULTIPLIER : 1.5;
